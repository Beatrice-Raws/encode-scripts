...
mplsFile - ссылка на MPLS файл, которому принадлежит медиа файл текущей дорожки. Эта информация позволяет более точно
...
При работе tsMuxer не использует внешних фильтров (кодеков).
